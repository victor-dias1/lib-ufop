	...
	<body>
		...
		<div class="container">
			...
			<div class="float-right">
				<a class="btn btn-primary" href="cadastraNovoLivro.php" role="button">Cadastrar Livro</a>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<p>Id do Livro</p>
								<form method="POST" action="processaDeletarLivro.php">
