    ...
    <main>
        ...
        <div class="content p-1">
                    ...
                    <table id="listaReservas" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <!-- Inicio Modal Apagar-->
                                <div class="modal fade" id="modalApagar<?php echo $row_reservas['rcodigoexemplar']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-center" id="myModalLabel">Deletar Reserva</h5>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            </div>
                                            <div class="modal-body">
                                                <blockquote class="blockquote">
                                                    <p class="mb-0">Tem certeza que deseja excluir a reserva do seu Banco de Dados?</p>
                                                </blockquote>
                                            </div>
                                            <div class="modal-footer">
                                                <a class="btn btn-outline-danger" href='../processar/deletar/reserva.php?id=<?php echo $row_reservas['rcodigoexemplar']; ?>' role="button">Excluir</a>
            ...
            <div class="d-flex justify-content-center">
                <a href="#">
                    <div class="p-2">
                        <button type="button" class="btn btn-lg btn-outline-success" data-toggle="modal" data-target="#modalCadastrarReserva"> Reservar </button>
                    </div>
                </a>
            </div>
        </div>
